...
Live Demo
Website: portfolio-atharvak.netlify.app
​
...
Portfolio Sections
Hero
The landing section introduces Atharva Kulkarni and positions the portfolio around cybersecurity, frontend development, and digital building.
​ It also includes call-to-action buttons for viewing projects and contacting the developer.
​
...
Tech Stack
Based on the site source, the portfolio uses static web technologies with HTML, CSS, Google Fonts, and browser-based visual effects.
